...
```{r}
#Analyze the structure and dimension of file
...
head(fang_et_al)
#Diplays first 6 observations of data set

tail(fang_et_al)
#Displays last 6 observations of data set
...
```{r}
# Create directory for maize data
...
# Combine the dataframes for maize and teosinte, adding a Group column
